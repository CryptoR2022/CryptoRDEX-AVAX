...
💱 `<InchDex />` : interface for [Moralis 1Inch Plugin](https://moralis.io/plugins/1inch?utm_source=github&utm_medium=readme&utm_campaign=CryptoRDEX). This plugin integrates the DeFi / DEX aggregator 1Inch to any project that uses Moralis.
